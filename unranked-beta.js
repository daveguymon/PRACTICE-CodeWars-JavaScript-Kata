// Anagram or Not? - https://www.codewars.com/kata/anagram-or-not/javascript
...
function isAnagram(test, original){
  let base = test.replace(/\W/g, '').toLowerCase().split('').sort().join('');
  let check = original.replace(/\W/g, '').toLowerCase().split('').sort().join('');
