// Acute, Obtuse, or Right? - https://www.codewars.com/kata/5a2ef8b7b6486a7f2e00001c
...
function obtRhtAct(sideLen) {
  var ordered = sideLen.sort((a,b) => a- b);
  var sumLegs = Math.pow(ordered[0],2) + Math.pow(ordered[1],2);
  var hypot = Math.pow(ordered[2],2);
